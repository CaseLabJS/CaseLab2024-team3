...
class ApiAttributeValueController {
  ...
  public static async getAttributeValueById(id: number): Promise<AxiosResponse<ChangeAttributeValue>> {
  ...
  public static async deleteAttributeValueById(id: number): Promise<AxiosResponse> {
    return api.delete(`/attribute-values/${id}`);
  }

  public static async createAttributeValue(data: CreateAttributeValue): Promise<AxiosResponse<ChangeAttributeValue>> {
    return api.post(`/attribute-values`, data);
  }

  public static async getDocumentAttributeValue(documentId: number, attributeId: number): Promise<AxiosResponse<ChangeAttributeValue>> {
    return api.get(`/attribute-values/${documentId}/${attributeId}`);
  }

  public static async getAttributeValuesByVersionId(documentVersionId: number): Promise<AxiosResponse<ChangeAttributeValue[]>> {

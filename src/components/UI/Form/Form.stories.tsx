...
const meta = {
    ...
    decorators: [
        (Story) => {
            ...
            return (
                <Form {...form}>
                    <form className='flex flex-col w-96 gap-2' onSubmit={form.handleSubmit(onSubmit)}>
                        <Story />
    ...
    render: ({ name, defaultValue, ...args }) => {
        ...
        return (
            <FormField
                ...
                render={({ field }) => <input className='border' {...field} {...args} name={name} defaultValue={defaultValue} />}
            />
        );
    },
    args: defaultArgs
